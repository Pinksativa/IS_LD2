...
for indx = 1:10000
    for n = 1:20
        ...
        v2_2 = y1_1*w21_2 + y2_1*w22_2 + y3_1*w23_2 + y4_1*w24_2 + y5_1*w25_2 + b2_2;
        ...
        w21_2 = w21_2 + mok_zing*delta_out_2*y1_1;
        w22_2 = w22_2 + mok_zing*delta_out_2*y2_1;
        w23_2 = w23_2 + mok_zing*delta_out_2*y3_1;
        w24_2 = w24_2 + mok_zing*delta_out_2*y4_1;
        w25_2 = w25_2 + mok_zing*delta_out_2*y5_1;
        b2_2 = b2_2 + mok_zing*delta_out_2*1;
...
for m = 1:100
    ...
    y2_apskaiciuota(m) = v2_2;
end

figure,
plot(x,y1,'kx',x,y2,'b*');
hold on
plot(x2,y1_apskaiciuota,'rx',x2,y2_apskaiciuota,'r*');
%% PAPILDOMA
clc; clear all; close all;
[X,Y,Z] = peaks(25);
C0(:,:,1) = zeros(25);
